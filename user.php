...
<center>
<div class="tableDiv">
<form action="" method="post" style="margin-top: 50px; max-width: 350px;" enctype="multipart/form-data">
...
<tr><td>Old Password: </td><td><input type="password" name="oPass" required/></td></tr>
</table>
