...
foreach($movies as $value)
	{
		...
		{
			print '<p style="color: red; margin-right: 0px; display: inline; font-size: 12px;">'.$title.'</p><br>'.PHP_EOL;
			$unmatched++;
		}		
	}
	print '</div>'.PHP_EOL;
	print '<div style="float: right; width: 250px; height: 50px;">'.PHP_EOL;
	print '<p style="margin-right: 0px; margin-top: 0px; display: inline; font-size: 12px;">Matched Files: '.$matched.'</p><br>'.PHP_EOL;
	print '<p style="color: red; margin-right: 0px; margin-top: 0px; display: inline; font-size: 12px;">Unmatched Files: '.$unmatched.'</p><br>'.PHP_EOL;
	print '</div>'.PHP_EOL;
	print '</div>'.PHP_EOL;
